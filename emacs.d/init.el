...
;; use tabs for indent, but tabbing again should trigger completions
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (pass markdown-mode markdown-mode+ tabbar-ruler color-theme hlinum vlf vdiff spinner solarized-theme rainbow-mode on-screen nlinum nim-mode indent-guide fish-mode ergoemacs-mode)))
