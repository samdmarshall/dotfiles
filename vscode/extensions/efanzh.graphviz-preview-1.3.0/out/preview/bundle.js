...
const theDefaultImage = theXmlParser.parseFromString('<svg xmlns="http://www.w3.org/2000/svg" width="100px" height="100px"></svg>', "image/svg+xml").rootElement;
...
onReady(() => {
    ...
    function registerEventListeners() {
        ...
        workspaceElement.addEventListener("pointerdown", (ev) => {
            ...
            const pointerMoveListener = (ev1) => handler(ev1.offsetX, ev1.offsetY);
